...
level 3 color codes of the source files to their index in [1, 45]. The 
...
>python map_corine2018_l3.py source_folder/ target_folder/
...
nc_masks = mapCorineL3_list(SOURCE_DIR, TARGET_DIR)
...
zip_file_name = parent_folder + '/' + 'l3_masks.zip'
